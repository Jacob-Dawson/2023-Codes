...
The second group of n=2 elements in original, [3,4], becomes the second row in the 
constructed 2D array.
...
public class convertingArray
{
    public static void main(String[] args) {
        ...
        int myArr[] = {1,2,3,4,5,6};//{1,2}; // change this
        ...
        for(int i = 0; i < m; i++){
            ...
            for(int j = 0; j < n; j++){
                ...
                newArr[i][j] = myArr[(i*n)+j];

            }

        }

        if(myArr.length != getLength(newArr)){
        ...
        System.out.println("");
        System.out.println("");
        System.out.println("@Jay 15/50 (2023)");
